...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_profile', (
            ...
            ('about', self.gf('elements.models.HTMLField')(default='', blank=True)),
            ('intro', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('referendum', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
        ))
        db.send_create_signal('users', ['Profile'])

        # Adding model 'Message'
        db.create_table('users_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent_messages', to=orm['users.Profile'])),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='received_messages', to=orm['users.Profile'])),
        ...
        db.send_create_signal('users', ['Message'])
        ...
        # Adding model 'WebObserver'
        db.create_table('users_webobserver', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_time', self.gf('django.db.models.fields.IntegerField')()),
            ('end_time', self.gf('django.db.models.fields.IntegerField')()),
            ('capture_video', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('users', ['WebObserver'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('users_message')

        # Deleting model 'CommissionMember'
        db.delete_table('users_commissionmember')

        # Deleting model 'WebObserver'
        db.delete_table('users_webobserver')
    ...
    models = {
        ...
        'users.profile': {
            ...
            'referendum': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10'}),
