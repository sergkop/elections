...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.tvd'
        db.delete_column('locations_location', 'tvd')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Location.tvd'
        raise RuntimeError("Cannot reverse this migration. 'Location.tvd' and its values cannot be restored.")
