...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ElectionLocation.tvd'
        db.alter_column('elections_electionlocation', 'tvd', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ElectionLocation.tvd'
        raise RuntimeError("Cannot reverse this migration. 'ElectionLocation.tvd' and its values cannot be restored.")
